...
public class MenuManager : MonoBehaviour
{
    ...
    public void LoadLocal()
    {
        ...
        optimizationSettings.initialGenotype = CreatureGenotype.LoadData("/arv-vesperferox.creature", SaveLocation.CREATURES); // null means start w/ random creatures. TODO: Non-null will mean spawn that with mutations!
